                ...
                {[
                    ...
                    >
                        <div className="flex flex-col gap-2">
                            <h4 className="text-[13px] font-bold text-slate-500 tracking-wider whitespace-nowrap uppercase opacity-60">{stat.label}</h4>
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-6 relative">
                                    ...
                                    <div className="text-center md:text-right pr-2">
                                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Cols</p>
