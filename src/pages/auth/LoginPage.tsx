        ...
        <div className="space-y-6 animate-fade-in w-full">
            <form onSubmit={handleLogin} className="space-y-5">
                ...
                <div className="flex items-center justify-between pb-2">
                    ...
                    <a href="#" className="text-sm font-semibold text-primary hover:text-primary/80">Forgot password</a>
                </div>
            ...
            <div className="space-y-3">
                <Button variant="outline" className="w-full h-11 font-medium border-blue-200 text-[#344054] hover:bg-gray-50 rounded-lg bg-white flex items-center justify-center gap-2 shadow-sm">
