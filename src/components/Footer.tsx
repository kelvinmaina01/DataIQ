    ...
    <footer className="bg-background border-t border-border relative overflow-hidden transition-colors duration-300">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          <div>
            <div className="flex items-center gap-3 mb-4 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              <img
                src={logoImage}
                alt="DataIQ Logo"
                className="h-14 sm:h-18 w-auto object-contain transition-transform group-hover:scale-110"
              />
          ...
          <div>
            <h4 className="font-bold mb-4 text-sm tracking-wide text-foreground uppercase">Product</h4>
          ...
          <div>
            <h4 className="font-bold mb-4 text-sm tracking-wide text-foreground uppercase">Features</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-bold mb-4 text-sm tracking-wide text-foreground uppercase">Company</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-border pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-muted-foreground">
            © 2025 <span className="font-semibold text-foreground">DataIQ</span>. All rights reserved.
          </div>
